            ...
            if (msg.what == ML_STATISTICS_MSG_WHAT_FROM_CLIENT_100) {
                ...
                if (statisticesModel.statisticesType.equals(ML_STATISTICS_INSERT_APP_CLICK)) {
                    ...
                    mlStatisticsServiceWeakReference!!.get()!!.singleThreadExecutor.execute(
                        SelectEnventTableRunnable(mlStatisticsServiceWeakReference!!.get()!!, statisticesModel.dayTime, CONSTANT_APP_CLICK, ML_STATISTICS_STATUS_10, statisticesModel.isNeedDeleteHistory)
                    )
                } else if (statisticesModel.statisticesType.equals(ML_STATISTICS_SELECT_APP_CLICK_BY_TIME)){
                    mlStatisticsServiceWeakReference!!.get()!!.singleThreadExecutor.execute(
                        SelectEnventTableRunnable(mlStatisticsServiceWeakReference!!.get()!!, statisticesModel.dayTime, CONSTANT_APP_CLICK, ML_STATISTICS_STATUS_20, statisticesModel.isNeedDeleteHistory)
                    )
                ...
                }else if (statisticesModel.statisticesType.equals(ML_STATISTICS_UPDATE_APP_CLICK_BY_TIME)){//更新事件
